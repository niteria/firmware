...
define INGENIC_OSDRV_T23_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 644 -t $(TARGET_DIR)/lib/modules/3.10.14/ingenic $(INGENIC_OSDRV_T23_PKGDIR)/files/kmod/*.ko
...
define INGENIC_OSDRV_T23_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 755 -d $(TARGET_DIR)/lib/modules/3.10.14/ingenic
	if [ -f $(INGENIC_OSDRV_T23_PKGDIR)/files/kmod/sensor_$(OPENIPC_SNS_MODEL)_$(OPENIPC_SOC_MODEL).ko ]; then \
		$(INSTALL) -m 644 -t $(TARGET_DIR)/lib/modules/3.10.14/ingenic $(INGENIC_OSDRV_T23_PKGDIR)/files/kmod/sensor_$(OPENIPC_SNS_MODEL)_$(OPENIPC_SOC_MODEL).ko; \
	fi
